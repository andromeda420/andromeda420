...
CHAPPAAI_TV_FOLDER = xbmcaddon.Addon('plugin.video.chappaai').getSetting('tv_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.chappaai)') else None
CHAPPAAI_MOVIE_FOLDER = xbmcaddon.Addon('plugin.video.chappaai').getSetting('movies_library_folder') if xbmc.getCondVisibility('System.HasAddon(plugin.video.chappaai)') else None
